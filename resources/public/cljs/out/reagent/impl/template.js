...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__21801__auto__,writer__21802__auto__,opt__21803__auto__){
return cljs.core._write.call(null,writer__21802__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__25532 = o;
(G__25532[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25534__i < G__25534__a.length) {G__25534__a[G__25534__i] = arguments[G__25534__i + 0]; ++G__25534__i;}
  args = new cljs.core.IndexedSeq(G__25534__a,0);
} 
...
if(cljs.core.truth_((function (){var and__21137__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__21137__auto__){
var and__21137__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__25541 = jsprops;
(G__25541["defaultValue"] = value);

(G__25541["onChange"] = ((function (G__25541,v,value,on_change){
return (function (p1__25538_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25538_SHARP_);
});})(G__25541,v,value,on_change))
);

(G__25541["ref"] = ((function (G__25541,v,value,on_change){
return (function (p1__25539_SHARP_){
return (this$["cljsInputElement"] = p1__25539_SHARP_);
});})(G__25541,v,value,on_change))
);
...
var vec__25548 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25548,(0),null);
var id = cljs.core.nth.call(null,vec__25548,(1),null);
var class$ = cljs.core.nth.call(null,vec__25548,(2),null);
...
var jsprops = ({"argv": v});
var temp__6751__auto___25553 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6751__auto___25553 == null)){
} else {
var key_25554 = temp__6751__auto___25553;
(jsprops["key"] = key_25554);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__25556 = (new reagent.impl.template.NativeWrapper());
(G__25556["name"] = c);
...
var len__22365__auto___25562 = arguments.length;
var i__22366__auto___25563 = (0);
while(true){
if((i__22366__auto___25563 < len__22365__auto___25562)){
args__22372__auto__.push((arguments[i__22366__auto___25563]));

var G__25564 = (i__22366__auto___25563 + (1));
i__22366__auto___25563 = G__25564;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__22373__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25560){
var G__25561 = cljs.core.first.call(null,seq25560);
var seq25560__$1 = cljs.core.next.call(null,seq25560);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__25561,seq25560__$1);
});
...
break;
default:
var G__25568 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__25568;
continue;
...
var n__22165__auto___25571 = a.length;
var i_25572 = (0);
while(true){
if((i_25572 < n__22165__auto___25571)){
(a[i_25572] = reagent.impl.template.as_element.call(null,(a[i_25572])));
...
var a = cljs.core.into_array.call(null,s);
var n__22165__auto___25574 = a.length;
var i_25575 = (0);
while(true){
if((i_25575 < n__22165__auto___25574)){
var val_25576 = (a[i_25575]);
if((cljs.core.vector_QMARK_.call(null,val_25576)) && ((reagent.impl.template.key_from_vec.call(null,val_25576) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25575] = reagent.impl.template.as_element.call(null,val_25576));
...
var ctx = ({});
var vec__25581 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25581,(0),null);
var derefed = cljs.core.nth.call(null,vec__25581,(1),null);
...
var G__25585 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25585) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25585){

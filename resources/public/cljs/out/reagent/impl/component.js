...
if((i < len)){
var k = (ks[i]);
var G__25465 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__25466 = (i + (1));
m = G__25465;
i = G__25466;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__25470 = c;
var G__25470__$1 = (((G__25470 == null))?null:G__25470.prototype);
if((G__25470__$1 == null)){
return null;
} else {
return (G__25470__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__25474 = c;
var G__25474__$1 = (((G__25474 == null))?null:G__25474.prototype);
if((G__25474__$1 == null)){
return null;
} else {
return (G__25474__$1["render"]);
}
})()));
});
...
var _STAR_current_component_STAR_25483 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_25483;
}});
...
var G__25487 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__25487) {
...
var or__21149__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__25489_25491 = (c["cljsRatom"]);
if((G__25489_25491 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25489_25491);
}
...
if(cljs.core.truth_((function (){var and__21137__auto__ = wrap;
...
var render_fun_25495 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_25494));
if((cljs.core.count.call(null,renders_25494) > (0))){
} else {
...
if(((1) === cljs.core.count.call(null,renders_25494))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_25495)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_25495))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__21149__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__21149__auto__)){
return or__21149__auto__;
} else {
...
var render_fun__$1 = (function (){var or__21149__auto__ = render_fun;
if(cljs.core.truth_(or__21149__auto__)){
return or__21149__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__21149__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__21149__auto__)){
return or__21149__auto__;
} else {
...
var name__$1 = (function (){var G__25493 = name;
switch (G__25493) {
case "":
...
var G__25498 = o;
(G__25498[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__25504 = (function (){var or__21149__auto__ = (function (){var G__25506 = c;
if((G__25506 == null)){
return null;
} else {
return (G__25506["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__21149__auto__)){
return or__21149__auto__;
...
return (G__25504["_currentElement"]);
}
})();
var name = (function (){var G__25507 = elem;
var G__25507__$1 = (((G__25507 == null))?null:(G__25507["type"]));
if((G__25507__$1 == null)){
return null;
} else {
return (G__25507__$1["displayName"]);
}
})();
var path = (function (){var G__25508 = elem;
var G__25508__$1 = (((G__25508 == null))?null:(G__25508["_owner"]));
var G__25508__$2 = (((G__25508__$1 == null))?null:reagent.impl.component.component_path.call(null,G__25508__$1));
if((G__25508__$2 == null)){
return null;
} else {
return [cljs.core.str(G__25508__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__21149__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__21149__auto__)){
return or__21149__auto__;
} else {
var G__25510 = c;
var G__25510__$1 = (((G__25510 == null))?null:G__25510.constructor);
if((G__25510__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__25510__$1);
}
}
})();

...
var x__21862__auto__ = (((rng == null))?null:rng);
var m__21863__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__21862__auto__)]);
if(!((m__21863__auto__ == null))){
return m__21863__auto__.call(null,rng);
} else {
var m__21863__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__21863__auto____$1 == null))){
return m__21863__auto____$1.call(null,rng);
} else {
...
var x__21862__auto__ = (((rng == null))?null:rng);
var m__21863__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__21862__auto__)]);
if(!((m__21863__auto__ == null))){
return m__21863__auto__.call(null,rng);
} else {
var m__21863__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__21863__auto____$1 == null))){
return m__21863__auto____$1.call(null,rng);
} else {
...
var x__21862__auto__ = (((rng == null))?null:rng);
var m__21863__auto__ = (clojure.test.check.random.split[goog.typeOf(x__21862__auto__)]);
if(!((m__21863__auto__ == null))){
return m__21863__auto__.call(null,rng);
} else {
var m__21863__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__21863__auto____$1 == null))){
return m__21863__auto____$1.call(null,rng);
} else {
...
var x__21862__auto__ = (((rng == null))?null:rng);
var m__21863__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__21862__auto__)]);
if(!((m__21863__auto__ == null))){
return m__21863__auto__.call(null,rng,n);
} else {
var m__21863__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__21863__auto____$1 == null))){
return m__21863__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__25800,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__25800;
}
});
...
var G__25803 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__25804 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__25803;
ret = G__25804;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__21801__auto__,writer__21802__auto__,opt__21803__auto__){
return cljs.core._write.call(null,writer__21802__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__21149__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__25806__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__25808 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__25808,(0),null);
var r2 = cljs.core.nth.call(null,vec__25808,(1),null);
...
var args25811 = [];
var len__22365__auto___25814 = arguments.length;
var i__22366__auto___25815 = (0);
while(true){
if((i__22366__auto___25815 < len__22365__auto___25814)){
args25811.push((arguments[i__22366__auto___25815]));

var G__25816 = (i__22366__auto___25815 + (1));
i__22366__auto___25815 = G__25816;
continue;
} else {
}
break;
